                                            ...
                                            {category.nfts.map((nft) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        {isUnlocked ? (
                                                            <img 
                                                                src={`${import.meta.env.BASE_URL}assets/${nft.image_path}`} 
                                                                alt={nft.name} 
                                                            />
                                                        ) : (
                ...
                >
                    {selectedNFT && (
                        <div className="nft-detail-container">
                            <img 
                                src={`${import.meta.env.BASE_URL}assets/${selectedNFT.nft.image_path}`} 
                ...
                >
                    {newlyUnlockedNFTs.length > 0 && (
                        <div className="unlocked-nft-container">
                            <img 
                                src={`${import.meta.env.BASE_URL}assets/${newlyUnlockedNFTs[0].nft.image_path}`} 
